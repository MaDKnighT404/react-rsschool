export const products = [
  ...
  },
  {
    ...
    description:
      "The product is originally manufactured by the company and it's a top selling product with a very reasonable",
    price: 60,
  ...
  },
  {
    ...
    description:
      'Product details of Golden Watch Pearls Bracelet Watch For Girls - Golden Chain Ladies Bracelate',
    price: 47,
  ...
  },
  {
    ...
    description:
      'Fashion Skmei 1830 Shell Dial Stainless Steel Women Wrist Watch Watch Quartz Watches Ladies',
    price: 35,
